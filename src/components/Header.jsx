...
function Header() {
  ...
  return (
    <header className="sticky top-0 bg-gray-800 text-white px-4 z-30">
      ...
      {/*모바일 메뉴 */}
      <aside
        className={`fixed top-0 left-0 w-64 h-full bg-gray-800 z-50 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:hidden transform transition-transform duration-300 ease-in-out`}
      >
